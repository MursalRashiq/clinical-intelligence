...
export interface ISlotService {
    ...
    blockDate(doctorId: string, data: BlockDatesDTO): Promise<ScheduleResponseDTO>;
    blockDateByUserId(userId: string, data: BlockDatesDTO): Promise<ScheduleResponseDTO>;
