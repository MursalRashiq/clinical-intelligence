...
export interface IDoctorRepository extends IBaseRepository<IDoctorDocument> {
    ...
    getDoctorRequestDetailsById(doctorId: string): Promise<DoctorRequestDetail | null>;

    getAllDoctors(skip: number, limit: number, filter?: { specialty?: string | undefined; search?: string | undefined; verificationStatus?: string | undefined; isActive?: boolean | undefined; sort?: Record<string, 1 | -1> | undefined; minExperience?: number | undefined; minRating?: number | undefined }): Promise<{ doctors: IDoctorDocument[]; total: number }>
