  ...
  implements IUserRepository
{
  ...
  async findByEmailIncludingInactive(
    email: string,
  ...
  async existsByPhone(phone: string): Promise<boolean> {
    return await this.existsByField('phone', phone);
  }
  ...
  ): Promise<{ patients: IUserDocument[]; total: number }> {
  ...
  async findByIdPopulatedFavorites(
