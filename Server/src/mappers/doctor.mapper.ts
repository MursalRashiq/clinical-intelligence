...
import { VerificationStatus, VerificationFormDataDTO } from "../dtos/doctor.dto/doctor.dto";
import { DOCTOR_PUBLIC_DEFAULTS } from "../constants/constants";
import { DoctorRequestDTO, DoctorRequestDetailsDTO } from "../dtos/admin.dto/admin.dto";
...
export class DoctorMapper {
    ...
    static toVerificationFormData(doctor: IDoctorDocument): VerificationFormDataDTO {
        return {
            ...
            rejectionReason: doctor.rejectionReason,
            verificationDocuments: doctor.verificationDocuments || [],
            canResubmit: doctor.verificationStatus === VerificationStatus.Reject,
        };
    }
    ...
    static toDoctorRequestDetailsDTO(doc: DoctorRequestDetail): DoctorRequestDetailsDTO {
        return {
            id: doc._id.toString(),
            customId: doc.customId || doc._id.toString(),
            name: doc.name,
            email: doc.email,
            phone: doc.phone || "",
            department: doc.specialty || "",
    ...
    static toDoctorListItem(doc: IDoctorDocument, userId: IUserDocument): DoctorListItem {
        return {
            id: doc._id.toString(),
            customId: userId.customId || doc._id.toString(),
            name: userId.name,
            email: userId.email,
            phone: userId.phone || "",
