...
export class DoctorMapper {
  ...
  static toPublicDTO(doctor: IDoctorDocument, user: IUserDocument) {
    const profileImage =
      user.profileImage ?? DOCTOR_PUBLIC_DEFAULTS.PROFILE_IMAGE;
  ...
  static toDoctorRequestDetailsDTO(
    doc: DoctorRequestDetail,
  ): DoctorRequestDetailsDTO {
    return {
      id: doc._id.toString(),
