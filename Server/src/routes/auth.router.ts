...
router.post(
  ...
  validate(AuthValidator.validateRegisterInput),
  authController.register,
);
router.post(
  AUTH_ROUTES.VERIFY_OTP,
  validate(AuthValidator.validateVerifyOtpInput),
  authController.verifyOtp,
);
router.post(
  AUTH_ROUTES.RESEND_OTP,
  validate(AuthValidator.validateResendOtpInput),
...
router.post(
  ...
  validate(AuthValidator.validateForgotPasswordInput),
  authController.forgotPassword,
);
router.post(
  AUTH_ROUTES.FORGOT_PASSWORD_VERIFY_OTP,
  validate(AuthValidator.validateForgotPasswordVerifyOtpInput),
