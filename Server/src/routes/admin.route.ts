...
const adminService = new AdminService(adminRepository, userRepository, doctorRepository, adminServiceLogger);
...
router.get(ADMIN_ROUTES.DOCTOR_REQUEST_DETAILS, authMiddleware, checkUserBlocked, requireAdmin, adminController.getDoctorRequestDetails);
router.post(ADMIN_ROUTES.APPROVE_DOCTOR, authMiddleware, checkUserBlocked, requireAdmin, adminController.approveDoctorRequest);
router.post(ADMIN_ROUTES.REJECT_DOCTOR, authMiddleware, checkUserBlocked, requireAdmin, adminController.rejectDoctorRequest);
