...
export const MESSAGES = {
  ...
  APPOINTMENT_MAX_RESCHEDULE: 'Maximum number of reschedules reached',
  APPOINTMENT_CANNOT_MODIFY: 'Appointment cannot be modified',
  ...
  EMAIL_CREDENTIALS_NOT_CONFIGURED:
    'mail credentials are not configured. Please set up SMTP settings to send emails.',
  EMAIL_SEND_FAILED:
  ...
  APPOINTMENT_DOCTOR_REQUIRED: 'Doctor is required',
  APPOINTMENT_DATE_REQUIRED: 'Date is required',
  APPOINTMENT_TIME_REQUIRED: 'Time is required',
  APPOINTMENT_TYPE_REQUIRED: 'Type is required',
  APPOINTMENT_SLOT_NOT_FOUND: 'Appointment slot not found',
  ...
  RAZORPAY_KEYS_NOT_CONFIGURED:
    'Razorpay keys are not configured. Please set up SMTP settings to send emails.',
  PAYMENT_APPOINTMENT_ID_REQUIRED: 'Appointment ID is required',
  ...
  PAYMENT_FIELDS_MISSING: 'Payment fields are missing',
  ...
  DOCTOR_FEES_NOT_SET: 'Doctor has not set fees for {type} consultations',
  APPOINTMENT_SLOT_NOT_AVAILABLE: 'Appointment slot not available',
  PAYMENT_SESSION_ACTIVE: 'Payment session is already active',
  APPOINTMENT_ONLY_PAID_APPROVED: 'Appointment only paid approved',
  APPOINTMENT_NOT_PENDING: 'Appointment is not in pending state',
  DOCTOR_NOT_AUTHORIZED: 'Doctor is not authorized to perform this action',
};
